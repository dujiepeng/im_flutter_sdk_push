...
import com.ease.im_flutter_sdk_push_huawei.hms.HmsNotificationIntentListener;
import com.ease.im_flutter_sdk_push_huawei.hms.HmsTokenHelper;
...
/** ImFlutterSdkPushHuaweiPlugin */
public class ImFlutterSdkPushHuaweiPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  /// The MethodChannel that will the communication between Flutter and native Android
  ///
  /// This local reference serves to register the plugin with the Flutter Engine and unregister it
  /// when the Flutter Engine is detached from the Activity
  private MethodChannel channel;
  private HmsTokenHelper hmsTokenHelper;
  HmsNotificationIntentListener notificationIntentListener;
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    hmsTokenHelper = new HmsTokenHelper(flutterPluginBinding.getApplicationContext());
    notificationIntentListener = new HmsNotificationIntentListener(flutterPluginBinding.getApplicationContext());
  }
