...
import com.ease.im_flutter_sdk_push_xiaomi.xiaomi.MiTokenHelper;
...
/** ImFlutterSdkPushXiaomiPlugin */
public class ImFlutterSdkPushXiaomiPlugin implements FlutterPlugin, MethodCallHandler  , ActivityAware {
  private MethodChannel channel;

  private MiTokenHelper tokenHelper;
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    tokenHelper = new MiTokenHelper(flutterPluginBinding.getApplicationContext());
